...
You can access the solution in this link --> [View SQL File](sql/1-final_project_school_analysis.sql)
...
You can access the solution in this link --> [View SQL File](sql/2-final_project_salary_analysis.sql)
...
You can access the solution in this link --> [View SQL File](sql/3-final_project_player_career_analysis.sql)
...
You can access the solution in this link --> [View SQL File](sql/4-final_project_player_comparison_analysis.sql)
